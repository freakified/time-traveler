...
static void set_animated_numbers(void *subject, WorldClockDataViewNumbers numbers) {
  ...
  time_traveler_view_model_fill_numbers(&data->view_model, numbers, data->data_point);
...
Animation *time_traveler_create_view_model_animation_numbers(WorldClockMainWindowViewModel *view_model, WorldClockDataPoint *next_data_point) {
  ...
  numbers = time_traveler_data_point_view_model_numbers(next_data_point);
...
static void bg_colors_animation_started(Animation *animation, void *context) {
  ...
  int city_index = time_traveler_index_of_data_point(dp);
  bool is_night = time_traveler_is_city_index_night(data, city_index);
  GColor color = time_traveler_data_point_color(dp, is_night);
...
static void bg_colors_animation_stopped(Animation *animation, bool finished, void *context) {
  ...
  time_traveler_view_model_fill_colors(view_model, color);
}

Animation *time_traveler_create_view_model_animation_bgcolor(WorldClockMainWindowViewModel *view_model, WorldClockDataPoint *next_data_point) {
